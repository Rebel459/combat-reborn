...
public class QuiverContents implements TooltipComponent {
	...
	public static class Mutable {
        ...
        public ItemStack removeOne(ItemStack quiverStack) {
            ...
            Integer rawSelected = quiverStack.get(CRDataComponents.QUIVER_CONTENTS_SLOT.get());
            ...
            if (this.items.isEmpty()) {
                quiverStack.set(CRDataComponents.QUIVER_CONTENTS_SLOT.get(), -1);
            } else if (selectedSlot >= this.items.size()) {
                quiverStack.set(CRDataComponents.QUIVER_CONTENTS_SLOT.get(), this.items.size() - 1);
            } else {
        ...
        public boolean consumeOne(ItemStack quiverStack) {
            ...
            if (selectedStack.isEmpty()) {
                ...
                if (this.items.isEmpty()) {
                    ...
                    quiverStack.set(CRDataComponents.QUIVER_CONTENTS_SLOT.get(), this.selectedSlot);
                }
            }
